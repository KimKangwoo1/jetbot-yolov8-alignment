...
[YouTube에서 시연 영상 보기](https://youtu.be/isyY7R11NFM)
...
- JetBot과 Ambulance 객체를 구분하기 위한 **학습 데이터 구축 과정에서 라벨링과 라벨 상태 점검**을 진행했습니다.
- 아래 수치는 제가 단독으로 수동 라벨링한 장수가 아니라, **최종 학습에 사용된 전체 데이터셋 규모**입니다.
